...
def build_dataset():
    ...
    dataset['gene', 'gene_disease', 'disease'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['gene', 'gene_chemical', 'chemical'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['gene', 'gene_phe', 'phe'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['gene', 'gene_mutation', 'mutation'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['gene', 'gene_pathway', 'pathway'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['gene', 'gene_gene', 'gene'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['disease', 'disease_chemical', 'chemical'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['disease', 'disease_phe', 'phe'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['disease', 'disease_mutation', 'mutation'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['disease', 'disease_pathway', 'pathway'].edge_attr = torch.ones(64, dtype=torch.float32)
    dataset['disease', 'disease_disease', 'disease'].edge_attr = torch.ones(64, dtype=torch.float32)
